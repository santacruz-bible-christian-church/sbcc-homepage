                        ...
                        <div className="max-w-5xl mx-auto">
                            ...
                            {featuredAnnouncement && (
                                <div className="mb-16">
                                    ...
                                    <article className="group bg-white border border-border/50 rounded-2xl p-8 md:p-10 hover:shadow-xl hover:border-primary/20 transition-all duration-300">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        {restAnnouncements.map((item, index) => {
                                            ...
                                            return (
                                                <article 
                                                    key={item.id} 
                                                    className="group bg-white border border-border/50 rounded-xl p-6 hover:shadow-lg hover:border-primary/20 transition-all duration-300 animate-in fade-in slide-in-from-bottom-3"
                                                    style={{ 
